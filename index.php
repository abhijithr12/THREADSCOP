...
<body>
    ...
    <div class="nav">
        <div>
            <a href="index.signup.php">Home</a>
            <a href="index.about.php">About Us</a>
            <a href="index.signup.php">Community</a>
            <a href="index.signup.php">Answer</a>
            <a href="index.signup.php">Profile</a>
            <a href="index.signup.php">ChatBot</a>
           
        </div>
       
        <a href="index.signup.php">
    ...
    <div class="content">
        ...
        <div class="sidebar">
            ...
            <div class="card">
                ...
                <p>CYBERSECURITY THREADS<button style="font-size:10px;padding: 10px; background-color:blue;color:white;border-radius:15px"><a href="index.signup.php"> join </button></p></a>
                <p>CYBER SECURITY<button style="font-size:10px;padding: 10px; background-color:blue;color:white;border-radius:15px"><a href="index.signup.php"> join </button></p></a>
            </div>
        </div>
    </div>
